...
public class Maze {
        ...
        for (int i = 0; i < Y_ROOMS * 2 + 1; i++){
            for (int o = 0; o < X_ROOMS * 2 + 1; o++){
                if (o % 2 == 0 && i % 2 == 0)
                    ...
                    string.append(rooms[o / 2][i / 2].color());
                else{
                    if (i % 2 == 0)
                        string.append(colorUpDownCheck(o /2, i / 2));
                    else {
                        string.append(colorSideSideCheck(o /2, i / 2));
                    }
                }
            }
            if (i == 0)
    ...
    String colorUpDownCheck(int x, int y) {
        if (y == 0)
            return "" + block;
        else if (y == Y_ROOMS)
            return "" + block;
    ...
    String colorSideSideCheck(int x, int y) {
        if (x == 0)
            return "" + block;
        else if (x == X_ROOMS)
            return "" + block;
